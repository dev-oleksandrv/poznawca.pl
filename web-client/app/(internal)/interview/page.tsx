...
import { ArrowRightIcon, Loader2Icon, MessageSquareIcon } from "lucide-react";
import { Card } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { interviewServiceSingleton } from "@/services/interview-service";
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert";

export default function InternalInterviewSetupPage() {
  ...
  const startInterviewHandler = async () => {
    ...
    try {
      const response = await interviewServiceSingleton.createInterview();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef] flex flex-col">
      <div className="flex-none container mx-auto py-4">
        <Link
          href="/"
                ...
                <div className="space-y-4">
                  <div className="bg-[#f8f9fa] rounded-xl p-4 border border-gray-100">
                    ...
                    <p className="text-gray-600 text-sm">
                      Try to answer in Polish, even if your language is not Polish. You can answer
                      in any available language if needed.
                    </p>
                  </div>

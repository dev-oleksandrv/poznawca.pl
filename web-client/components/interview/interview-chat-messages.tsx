...
import { InterviewMessageDto, InterviewMessageRole } from "@/dto/interview-dto";
...
export function InterviewChatMessages({ messages, isPending }: InterviewChatMessagesProps) {
